...
Write-Host "Publish app" -ForegroundColor Yellow;
$publishProcess = Start-Process dotnet -ArgumentList "publish", "-c", "Release", "/bl:publish.binlog" -NoNewWindow -PassThru;
